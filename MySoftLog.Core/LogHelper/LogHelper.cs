...
namespace MySoftLog.Core.LogHelper
{
    /// <summary>
    /// 
    /// </summary>
    public class LogHelper : ILogHelper
    {
        ...
        /// <returns></returns>
        private log4net.ILog GetLogger(Type source)
        {
            ...
            {
                ILog logger = LogManager.GetLogger(ConstString.AppName, source);
        ...
        {
            log4net.ILog logger = GetLogger(source);
        ...
        public void Debug(IInvocation invocation, Exception exception)
        {
            //todo:待记录
        }
        ...
        /// </summary>
        /// <param name="invocation"></param>
        public void ExecuteApi(IInvocation invocation)
        {
            //todo: 记录操作日志
        }
    }
